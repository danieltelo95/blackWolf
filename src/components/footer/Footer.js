        ...
        <div className="w-full sm:w-1/3 px-4 mb-6 sm:mb-0">
          ...
          <ul className="list-none">
            <li className="mb-2 flex items-center">
              ...
              <a 
                href="https://wa.link/8qd5ak"
                className="hover:text-gray-400"  // Puedes ajustar el color del texto en hover si es necesario
            ...
            <li className="mb-2 flex items-center mb-8">
              ...
              <a 
                href="https://www.instagram.com/andrewtarot99?igsh=c3U0b2ptczk4N3A2"
                className="hover:text-gray-400"  // Puedes ajustar el color del texto en hover si es necesario
                style={{ textDecoration: 'none' }} // Asegura que no haya subrayado
              >
                Instagram
