  ...
  return (
    <div>
      <section className="relative isolate overflow-hidden px-6 py-24 sm:py-32 lg:px-8">
        ...
        <div className="absolute inset-y-0 right-1/2 -z-10 mr-16 w-[200%] origin-bottom-left skew-x-[-30deg] sm:mr-28 lg:mr-0 xl:mr-16 xl:origin-center"></div>
        <div className="mx-auto max-w-2xl lg:max-w-4xl">
          ...
          <figure className="mt-10">
            <blockquote className="text-center text-xl font-semibold leading-8 text-white sm:text-2xl sm:leading-9">
              <p>“La mejor lectura de Tarot, el curso es buenísimo
                  Muy recomendado, Gracias por todo!
                  ”</p>
            </blockquote>
            <figcaption className="mt-10">
              ...
              <div className="mt-4 flex items-center justify-center space-x-3 text-base">
                <div className="font-semibold text-white">Daniel Tello</div>
